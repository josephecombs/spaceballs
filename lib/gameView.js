(function () {
  ...
  GameView.prototype.bindKeyHandlers = function () {
	 ...
	 //add mouse hover actions - i.e. aim the ship's turret at wherever the mouse is hovering maybe do this in the ship draw function
  ...
  GameView.prototype.start = function (canvasEl) {
	...
	$('canvas').mousemove(function(event) {
		...
		that.game.ship.updateDirection(event);
