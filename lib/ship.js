(function () {
  ...
  Ship.prototype.draw = function (ctx) {
	...
	//leverage "gameView"/stage   .getPointerPosition()
	//see http://www.html5canvastutorials.com/kineticjs/html5-canvas-path-mouseover/
	
	//DOES NOT WORK: console.log(this.gameView);
	//DOES NOT WORK: console.log(window.getPointerPosition());
	

    //this is where ship rendering starts for a triangle
